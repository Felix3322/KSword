...
namespace ks
{
    namespace crash
    {
        const wchar_t kSkipSingleInstanceArgument[] = L"--ksword-skip-single-instance";
        ...
        bool WaitForCrashRestartTargetFromCommandLine(const DWORD timeoutMilliseconds)
        {
            ...
            {
                (void)::WaitForSingleObject(processHandle, timeoutMilliseconds);
