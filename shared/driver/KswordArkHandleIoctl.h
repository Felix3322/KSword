...
// Batch scans can inspect thousands of handles. This flag only suppresses
// per-request success records; validation, transport and semantic failures
// remain visible through the normal driver error path.
#define KSWORD_ARK_ENUM_HANDLE_FLAG_QUIET_LOG            0x80000000UL
...
#define KSWORD_ARK_QUERY_OBJECT_FLAG_QUIET_LOG          0x80000000UL
