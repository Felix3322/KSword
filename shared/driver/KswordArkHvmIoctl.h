...
#define KSWORD_ARK_IOCTL_FUNCTION_HVM_EPT_RULE 0x8CCUL
#define KSWORD_ARK_IOCTL_FUNCTION_HVM_EVENTS   0x8CDUL
...
/*
 * START_RESIDENT is retained for protocol compatibility.  An unloadable image
 * must return unsupported until it owns S3/S4/modern-standby transitions and
 * can prove every CPU has left VMX before power change or image removal.
 */
